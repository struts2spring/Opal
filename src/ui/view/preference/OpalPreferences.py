...
def FindImages(text, widgetName):
    ...
    control), this method will try and download the 
...
def HuntExternalDemos():
    ...
    for extern in keys:
        ...
        catalog[extern] = package.GetDemoBitmap()
...
#         icon=wx.EmptyImage(16, 16)
        ...
        for indx in xrange(9):
            bmp = catalog["spinning_nb%d"%indx].GetBitmap()
            imgList.Add(bmp)
    ...
    def BuildMenuBar(self):
        ...
        exitItem.SetBitmap(catalog['exit'].GetBitmap())
        ...
        for indx, item in enumerate(_treeList[:-1]):
            ...
            menuItem.SetBitmap(catalog[_demoPngs[indx+1]].GetBitmap())
        ...
        item.SetBitmap(catalog['deletedocs'].GetBitmap())
        menu.AppendItem(item)
        ...
        item.SetBitmap(catalog['expansion'].GetBitmap())
        menu.AppendItem(item)
        ...
        shellItem.SetBitmap(catalog['pyshell'].GetBitmap())
        ...
        inspToolItem.SetBitmap(catalog['inspect'].GetBitmap())
